...
|`Domain*.rdf`|The list of separate domain ontologies, one ontology file per domain. Each domain ontology file is included in the root ontology file. The `DomainTemplate.rdf` file should be copied for new domains - see the [guide](https://gov-uk.atlassian.net/wiki/spaces/GIA/pages/edit-v2/5566988289) on how to do this.|
|`Taxonomy*.rdf`|The list of separate taxonomy ontologies, one ontology file per taxonomy. Each taxonomy ontology file is included in the root ontology file. The `TaxonomyTemplate.rdf` file should be copied for new taxonomy - see the [guide](https://gov-uk.atlassian.net/wiki/spaces/GIA/pages/edit-v2/5566988289) on how to do this.|
|`ContentBlock*.rdf`|The list of separate content block ontolgies, one ontology file per content block. Each content block ontology file is included in the root ontology file. The `ContentBlockTemplate.rdf` file should be copied for new content block - see the [guide](https://gov-uk.atlassian.net/wiki/spaces/GIA/pages/edit-v2/5566988289) on how to do this.|
|`ContentType*.rdf`|The list of separate content type ontolgies, one ontology file per content type. Each content type ontology file is included in the root ontology file. The `ContentTypeTemplate.rdf` file should be copied for new content block - see the [guide](https://gov-uk.atlassian.net/wiki/spaces/GIA/pages/edit-v2/5566988289) on how to do this.|
